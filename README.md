...
CVs. Translated text fields are `{ "en": …, "es": …, "de": … }`, and a missing `de` falls back
...
`"related": ["<id>"]`, and the two bubbles then attract and touch. Add `"platform": "github"`
...
GitHub Pages via Actions (`.github/workflows/deploy.yml`), which uploads the folder verbatim
